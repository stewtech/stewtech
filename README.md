<p align="center">
  <img src="/mnt/data/Horseshoe Bend Arizona.jpg" alt="Banner Image" width="100%">
</p>
...
💡 Frontend Web Development:🎨 HTML5, CSS3, Bootstrap⚡ JavaScript (ES5-ES14), jQuery, Ajax🚀 React, Angular🔧 Webpack & Vite

💡 .NET Development:🖥️ .NET Blazor UI (Razor components)🔍 Swagger for API testing💾 Entity Framework Core & Dapper🗄️ MS SQL for database management
